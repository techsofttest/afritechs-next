...
export default function ChairmanMessage() {
  return (
    <section className="relative bg-[#0c2847] text-white py-12 md:py-20 px-4 md:px-16 lg:px-24 overflow-hidden w-full border-b border-gray-800">
      {/* Slanted green background shape from InnerPageHero */}
      <div
      ...
      <div className="max-w-[1440px] mx-auto relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-8 md:gap-12 items-center">
          <div className="w-full lg:w-1/3 relative aspect-square max-w-[280px] sm:max-w-[320px] rounded-full overflow-hidden">
            <Image
              src="https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=400&q=80"
              alt="Mr Arun, Chairman"
              fill
              className="object-cover"
            />
          </div>
          <div className="w-full lg:w-2/3 flex flex-col items-start text-left">
            <h3 className="text-xl md:text-2xl font-semibold mb-4 md:mb-6 text-white">Guider Afri-techs vers l&apos;avenir</h3>
            <p className="text-gray-200 text-sm md:text-base lg:text-lg italic leading-relaxed mb-4 md:mb-6 font-medium">
              &ldquo;Depuis la fondation d&apos;Afri-techs en 2015, notre ambition a toujours été de construire un pont d&apos;excellence industrielle entre la Guinée, les Émirats Arabes Unis et les marchés mondiaux. En apportant des solutions complètes de mécanisation agricole et d&apos;automobile aux communautés locales, nous permettons aux entreprises de prospérer et de réaliser une croissance durable.&rdquo;
            </p>
            <span className="font-semibold text-white text-base md:text-lg">Mr. Arun</span>
            <span className="text-[10px] md:text-xs text-gray-300 font-semibold uppercase tracking-wider">Fondateur & Président, Afri-techs</span>
          </div>
        </div>
      </div>
    </section>
